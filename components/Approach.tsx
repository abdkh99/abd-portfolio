      ...
      <section className="w-full py-20">
        <h1 className="heading">
          ...
          <TextShimmer
            spread={5}
            duration={2.2}
            className="font-bold [--base-color:var(--color-purple-600)] [--base-gradient-color:var(--color-purple-200)] dark:[--base-color:var(--color-purple-700)] dark:[--base-gradient-color:var(--color-purple-400)] "
          >
            approach
          </TextShimmer>
        </h1>
