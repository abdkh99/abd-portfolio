      ...
      <div className="pb-20 pt-36 relative">
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            ...
            <GradualSpacing
            duration={0.8}
              mainClassName="text-md md:text-5xl font-bold tracking-tighter lg:text-6xl"
            ...
            >
              ...
              duration={0.8}
                ...
                mainClassName="text-purple-500 block text-[40px] md:text-5xl lg:text-6xl font-semibold"
              ></GradualSpacing>
            </motion.div>
            <GradualSpacing
            duration={0.7}
              mainClassName="text-md  text-center text-[8px] md:text-lg lg:text-xl text-white mb-10 tracking-tighter"
