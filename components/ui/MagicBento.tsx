...
const cardData: BentoCardProps[] = [
  {
    ...
    description: "with time zone communications",
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[350px] w-full max-w-full p-6 rounded-[24px] border-2 border-solid font-light overflow-hidden transition-all duration-300 ease-in-out  hover:shadow-[0_12px_30px_rgba(0,0,0,0.2)] ${
            ...
            const cardStyle = {
              ...
              backgroundRepeat: card.bgImage ? "no-repeat" : undefined,
